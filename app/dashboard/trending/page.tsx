...
export default function TrendingPage() {
  const { data, error } = useSWR("/api/scores/trending?limit=20", fetcher);

  if (error) return <div className="p-6">Error loading trending</div>;
  if (!data) return <div className="p-6">Loading...</div>;

  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold">🚀 Trending Idols</h1>
